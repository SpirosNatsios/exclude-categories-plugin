...
function shop_page_options_page()
{
    ...
    <div class="wrap">
        ...
        <form action="options.php" method="post">
            <?php settings_fields('shop_page_options_group'); ?>
            <?php do_settings_sections('shop_page_options_group'); ?>
            <h2>Select the categories you want excluded from the shop page</h2>
            <table class="form-table">
                <tbody>
                    <tr valign="top">
                        <th scope="row">
                            <?php _e('Categories', 'shop_page_excluded_categories'); ?>
                        </th>
                        <td>
                            <?php foreach ($categories as $category): ?>
                                <label>
                                    <input type="checkbox" name="shop_page_excluded_categories[]"
